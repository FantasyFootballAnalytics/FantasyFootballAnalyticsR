...
This is an example of the sort of work product or article we can produce automatically each week.  We can be creative about the text generation, which will take some work, but for the most part we should let the statistics do the work.
