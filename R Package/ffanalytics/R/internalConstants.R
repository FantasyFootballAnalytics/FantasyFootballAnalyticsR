...
correct.from <- c("Ty Hilton", "Timothy Wright", "Christopher Ivory", "Domanique Davis", "Ben Watson", "Stevie Johnson",	"Lesean McCoy",
                  ...
                  "CJ Prosise", "AJ Green", "David A. Johnson", "Adrian L. Peterson", "Jonathan C. Stewart", "Chris D. Johnson", "Austin D. Johnson",
                  "Steve L. Smith", "Michael A. Thomas", "Devin A. Smith", "Michael D. Thomas")
...
correct.to <- c("T.Y. Hilton", "Tim Wright", "Chris Ivory", "Dominique Davis", "Benjamin Watson", "Steve Johnson", "LeSean McCoy",
                ...
                "T.J. Yeldon", "C.J. Prosise", "A.J. Green", "David Johnson", "Adrian Peterson" ,"Jonathan Stewart", "Chris Johnson", "Austin Johnson",
                "Steve Smith", "Michael Thomas", "Devin Smith", "Michael Thomas")
