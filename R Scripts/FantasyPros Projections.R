...
projections_fp$passYds_fp <- as.numeric(projections_fp$passYds_fp)
...
projections_fp$rushYds_fp <- as.numeric(projections_fp$rushYds_fp)
projections_fp$rushTds_fp <- as.numeric(projections_fp$rushTds_fp)
projections_fp$rec_fp <- as.numeric(projections_fp$rec_fp)
projections_fp$recYds_fp <- as.numeric(projections_fp$recYds_fp)
