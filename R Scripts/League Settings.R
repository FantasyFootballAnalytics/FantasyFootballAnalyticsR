...
#Projections
sourcesOfProjections <- c("Accuscore", "CBS", "ESPN", "FantasyPros", "FantasySharks", "FFtoday", "NFL", "Yahoo")
sourcesOfProjectionsAbbreviation <- c("accu", "cbs", "espn", "fp", "fs", "fftoday", "nfl", "yahoo")
